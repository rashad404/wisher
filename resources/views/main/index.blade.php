            ...
            <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                    ...
                    <div class="mt-12 lg:mt-0 lg:col-span-6">
                        <img class="mx-auto lg:mx-0 lg:max-w-none" src="{{ asset('images/hero-image.png') }}" alt="Hero Image">
                    </div>
                </div>
            </main>
        </div>
      ...
      <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div class="border rounded-lg shadow-sm overflow-hidden">
              <div class="px-6 py-8 bg-white">
                  ...
                  <p class="mt-4 text-gray-600">123</p>
                  <div class="mt-6">
              ...
              <div class="px-6 py-6 bg-gray-50">
                  ...
                  <div class="mt-8">
                      <a href="/pricing" class="block w-full text-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-[#E9654B] hover:bg-[#d45a43]">
                          {{ __('messages.sign_up') }}
                      </a>
                  </div>
              </div>
