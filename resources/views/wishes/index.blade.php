...
<div class="container mx-auto py-8">
    <h1 class="text-3xl font-semibold text-center mb-6">Wish Templates</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        @foreach($wishes as $wish)
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <p class="text-sm text-gray-500">Event: {{ $wish->event->name }}</p>
            </div>
        @endforeach
    </div>
    ...
    @if($wishes->isEmpty())
        <div class="text-center text-gray-500 mt-6">
            <p>No wishes found for the selected filters.</p>
        </div>
    @endif
</div>
