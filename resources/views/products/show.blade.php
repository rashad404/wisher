...
<div class="bg-white">
    ...
    <div class="pb-8 pt-6 sm:pb-16">
            ...
            <ol role="list" class="flex items-center space-x-4">
                <li>
                    <div class="flex items-center">
                        <a href="{{ route('products.category', $product->category->id) }}" class="mr-4 text-sm font-medium text-gray-900 hover:text-indigo-600">{{ $product->category->name }}</a>
                ...
                <li>
                    <div class="flex items-center">
                        <a href="{{ route('products.brand', $product->brand->id) }}" class="mr-4 text-sm font-medium text-gray-900 hover:text-indigo-600">{{ $product->brand->name }}</a>
                        <svg viewBox="0 0 6 20" aria-hidden="true" class="h-5 w-auto text-gray-300">
                            <path d="M4.878 4.34H3.551L.27 16.532h1.327l3.281-12.19z" fill="currentColor" />
                        </svg>
                    </div>
                ...
                <li class="text-sm">
                    <a href="#" aria-current="page" class="font-medium text-gray-500 hover:text-indigo-600">{{ $product->name }}</a>
                </li>
            </ol>
        </nav>
        ...
        <div class="mx-auto mt-4 max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div class="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:auto-rows-min">
                <!-- Product Info -->
                ...
                <div class="mt-8 lg:col-span-7 lg:col-start-1 lg:row-span-3 lg:row-start-1 lg:mt-0">
                    ...
                    <div class="relative aspect-w-1 aspect-h-1 overflow-hidden rounded-lg shadow-lg">
                ...
                <div class="mt-4 lg:col-span-5">
                    <form id="add-to-cart-form" method="POST" action="{{ route('cart.add', ['productId' => $product->id]) }}">
                        ...
                        <!-- "Add to Cart" Button with orange styling -->
                        @auth
                        <button id="add-to-cart-btn" type="submit" onclick="addToCart()"
                            class="mt-4 flex w-full items-center justify-center rounded-md border border-transparent px-8 py-3 text-base font-medium text-white transition-all"
                            style="background-color: #E9654B;"
                            onmouseover="this.style.backgroundColor='#d45a43';"
                            onmouseout="this.style.backgroundColor='#E9654B';">
                            Add to cart
                        </button>
