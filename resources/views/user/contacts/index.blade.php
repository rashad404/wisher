            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              <tr>
                  ...
                  <div class="flex items-center">
                    ...
                    <div class="ml-4">
                      <div class="font-medium text-gray-900">
                        <a href="/user/contacts/view/1" class="text-indigo-600 hover:text-indigo-900">Lindsay Walton</a>
                    </div>
                ...
                <td class="relative whitespace-nowrap py-5 pl-3 pr-4 text-right text-sm font-medium sm:pr-0">
                  <a href="/user/contacts/edit/1" class="text-indigo-600 hover:text-indigo-900">Edit<span class="sr-only">, Lindsay Walton</span></a>
                </td>
              </tr>
