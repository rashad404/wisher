  ...
  <div class="mx-auto max-w-7xl px-6 pb-8 pt-20 sm:pt-24 lg:px-8 lg:pt-32">
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      <div class="grid grid-cols-2 gap-8 xl:col-span-2">
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li>
                <a href="{{ route('main.about') }}" class="text-sm leading-6 text-gray-300 hover:text-white">About Us</a>
              </li>
              <li>
                <a href="{{ route('main.howItWorks') }}" class="text-sm leading-6 text-gray-300 hover:text-white">How It Works</a>
              </li>
              <li>
                <a href="{{ route('gifts.index') }}" class="text-sm leading-6 text-gray-300 hover:text-white">Gifts</a>
              </li>
              <li>
                <a href="{{ route('products.index') }}" class="text-sm leading-6 text-gray-300 hover:text-white">Products</a>
              </li>
            </ul>
          </div>
          <div class="mt-10 md:mt-0">
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li>
                <a href="{{ route('password.request') }}" class="text-sm leading-6 text-gray-300 hover:text-white">Forgot Password</a>
              </li>
              <li>
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          <div>
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li>
                <a href="{{ route('login') }}" class="text-sm leading-6 text-gray-300 hover:text-white">Login</a>
              </li>
              <li>
                <a href="{{ route('register') }}" class="text-sm leading-6 text-gray-300 hover:text-white">Register</a>
              </li>
              <li>
                <a href="{{ route('user.index') }}" class="text-sm leading-6 text-gray-300 hover:text-white">Dashboard</a>
              </li>
            </ul>
          </div>
          <div class="mt-10 md:mt-0">
            ...
            <ul role="list" class="mt-6 space-y-4">
              ...
              <li>
                <a href="/terms" class="text-sm leading-6 text-gray-300 hover:text-white">Terms of Service</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="mt-10 xl:mt-0">
        ...
        <p class="mt-2 text-sm leading-6 text-gray-300">Get the latest updates, articles, and resources delivered weekly to your inbox.</p>
    ...
    <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
      ...
      <p class="mt-8 text-xs leading-5 text-gray-400 md:order-1 md:mt-0">&copy; <?php echo date("Y"); ?> wisher.az | All rights reserved.</p>
    </div>
  </div>
</footer>
